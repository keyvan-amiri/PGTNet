...
def get_global_stat_func (training_validation_log, training_validation_df, case_num_ful,
    ...
    # Achtung! For ablation study in the following line 7 is changed to 6.
    edge_dim  = attribute_cardinality + case_cardinality + case_num_card + event_num_card + 6 
        ...
        if case_length < 3:
            ...
            for prefix_length in range (2, case_length):
                ...
                for edge in edge_index:
                    ...
                    # Achtung! the following two lines are commented to avoid using workload feature
