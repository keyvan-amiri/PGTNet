...
4. [GGNN](https://dl.acm.org/doi/abs/10.1145/3589883.3589897): A graph-based approach which utilizes Gated Graph Neural Network (GGNN) for remaining time prediction. To implement this baseline we used 
